...
const PrintableFormPemusnahanBarang = ({ detailKeluar, headerKeluar }) => {
    ...
    <div style={{ padding: "20px", border: "1px solid #ccc", borderRadius: "10px" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between" }}>
        <div style={{ textAlign: "left", width: "50%" }}>
          <p>
            <strong>Nota:</strong> {headerKeluar?.hpemusnahan_nota}
          </p>
          <p>
            <strong>Tanggal dibuat : </strong>{" "}
            {dayjs(headerKeluar?.created_at).format("DD-MM-YYYY")}
          </p>
          <p>
            <strong>Tanggal pemusnahan: </strong>{" "}
            {dayjs(headerKeluar?.hpemusnahan_tanggal).format("DD-MM-YYYY")}
          </p>
        </div>
        <div style={{ textAlign: "left", width: "50%" }}>
          <p>
            <strong>Catatan pemusnahan:</strong> {headerKeluar?.hpemusnahan_catatan}
          </p>
          <p>
            <strong>Pembuat :</strong> {headerKeluar?.pengguna_generate?.pengguna_nama}
          </p>
          <p>
            <strong>Disetujui Oleh :</strong> {headerKeluar?.pengguna_action?.pengguna_nama}
          </p>
        </div>
      </div>
...
PrintableFormPemusnahanBarang.propTypes = {
  detailKeluar: PropTypes.array.isRequired,
  headerKeluar: PropTypes.object.isRequired,
};

export default PrintableFormPemusnahanBarang;
